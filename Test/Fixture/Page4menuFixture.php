 ...
 */
	public $records = array(
		...
		array(
			'id' => '1', 'room_id' => '1', 'root_id' => null, 'parent_id' => null, 'lft' => '1', 'rght' => '16',
			'permalink' => '', 'slug' => null,
		),
		//パブリックスペースのホーム
		array(
		...
		array(
			'id' => '9', 'room_id' => '1', 'root_id' => '1', 'parent_id' => '1', 'lft' => '8', 'rght' => '13',
			'permalink' => 'page_1', 'slug' => 'page_1',
		),
		//page.permalink=page_1/page_3
		array(
			'id' => '11', 'room_id' => '1', 'root_id' => '1', 'parent_id' => '9', 'lft' => '9', 'rght' => '12',
			'permalink' => 'page_3', 'slug' => 'page_3',
		),
		//page.permalink=page_1/page_3/page_6
		array(
			'id' => '12', 'room_id' => '1', 'root_id' => '1', 'parent_id' => '11', 'lft' => '10', 'rght' => '11',
			'permalink' => 'page_6', 'slug' => 'page_6',
		),
		//page.permalink=page_2
		array(
			'id' => '10', 'room_id' => '1', 'root_id' => '1', 'parent_id' => '1', 'lft' => '14', 'rght' => '15',
			'permalink' => 'page_2', 'slug' => 'page_2',
		),

		//プライベートスペースのページ（使われることはない）
		array(
			'id' => '2', 'room_id' => '2', 'root_id' => null, 'parent_id' => null, 'lft' => '17', 'rght' => '18',
			'permalink' => '', 'slug' => null,
		),
		//グループスペースのページ（使われることはない）
		array(
			'id' => '3', 'room_id' => '3', 'root_id' => null, 'parent_id' => null, 'lft' => '19', 'rght' => '24',
			'permalink' => '', 'slug' => null,
		),
		//別ルーム(room_id=4)
		array(
			'id' => '5', 'room_id' => '4', 'root_id' => '3', 'parent_id' => '3', 'lft' => '20', 'rght' => '21',
			'permalink' => 'test2', 'slug' => 'test2',
		),
		//別ルーム(room_id=5、ブロックなし)
		array(
			'id' => '6', 'room_id' => '5', 'root_id' => '3', 'parent_id' => '3', 'lft' => '22', 'rght' => '23',
