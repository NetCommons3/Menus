<?php
/**
 * View/Elements/Menus/main/indexのテスト
 *
 ...
 *
 * @author Shohei Nakajima <nakajimashouhei@gmail.com>
 * @package NetCommons\Menus\Test\Case\View\Elements\Menus\main\Index
 */
class MenusViewElementsMenusMainIndexTest extends NetCommonsControllerTestCase {
 ...
 */
	public function setUp() {
		...
		//テストコントローラ生成
		$this->generateNc('TestMenus.TestViewElementsMenusMainIndex');
	}
 ...
 */
	public function testIndex() {
		...
		//テスト実行
		$this->_testGetAction('/test_menus/test_view_elements_menus_main_index/index?frame_id=' . $frameId,
				array('method' => 'assertNotEmpty'), null, 'view');

		//チェック
		$pattern = '/' . preg_quote('View/Elements/Menus/main/index', '/') . '/';
