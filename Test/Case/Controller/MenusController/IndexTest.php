 ...
 *
 * @author Shohei Nakajima <nakajimashouhei@gmail.com>
 * @package NetCommons\Menus\Test\Case\Controller\MenusController
 */
class MenusControllerIndexTest extends NetCommonsControllerTestCase {
 ...
 */
	public function testIndexGet() {
		...
		//チェック
		$this->assertTextContains('<nav ng-controller="MenusController" ng-cloak>', $this->view);
	}
